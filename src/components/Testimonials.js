...
function Testimonials(props) {
    ...
    return (
        <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
            ...
            <div className='flex text-3xl mt-10 gap-3 text-violet-400 font-bold justify-center text-center mx-auto'>
            ...
            <div>
                ...
                cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg mt-8'>
                    Surprise Me
                </button>
            </div>
        </div>
